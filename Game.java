...
public class Game 
{
    ...
    {
        Room entrada, mcdonalds, burgerKing, dominosPizza, tacoBell, subway, kfc;
      
        // create the rooms
        entrada = new Room("Entrada del centro comercial");
        mcdonalds = new Room("Mcdonald`s");
        burgerKing = new Room("Burger King");
        dominosPizza = new Room("Domino´s Pizza");
        tacoBell = new Room("Taco Bell");
        subway = new Room ("Subway");
